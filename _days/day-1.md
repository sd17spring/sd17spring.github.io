...
1. The case for interdisciplinary computer science ([PDF]({{ site.data.course.urls.intro_lecture.pdf }}), [PowerPoint]({{ site.data.course.urls.intro_lecture.ppt }}))
2. Course overview
...
exercises for the course. Specifically, we will be having everyone sign up for
