...
repository](https://github.com//{{site.data.course.github_owner}}/ComputationalArt) for the
...
request from your ComputationalArt repo to the {{site.data.course.github_owner}} ComputationalArt
repo.**
...
1pm the day that the assignment is due.
